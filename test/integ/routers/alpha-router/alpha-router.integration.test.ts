...
import { ChainId, Currency, CurrencyAmount, Ether, Percent, Token, TradeType, } from '@tpvinh/sdk-core';
import {
  PERMIT2_ADDRESS,
  UNIVERSAL_ROUTER_ADDRESS as UNIVERSAL_ROUTER_ADDRESS_BY_CHAIN,
} from '@tpvinh/universal-router-sdk';
import { Permit2Permit } from '@tpvinh/universal-router-sdk/dist/utils/inputTokens';
...
describe('quote for other networks', () => {
  const TEST_ERC20_1: { [chainId in ChainId]: () => Token } = {
    ...
    [ChainId.OP_BNB]: () => USDC_ON(ChainId.OP_BNB),
    [ChainId.ONUS_TEST]: () => USDC_ON(ChainId.ONUS_TEST),
  };
  const TEST_ERC20_2: { [chainId in ChainId]: () => Token } = {
    ...
    [ChainId.OP_BNB]: () => WNATIVE_ON(ChainId.OP_BNB),
    [ChainId.ONUS_TEST]: () => WNATIVE_ON(ChainId.ONUS_TEST),
